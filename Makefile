...
${BUILD_DIR}/ms_debug.x: $(BUILD_DIR)/ms_debug.o $(BUILD_DIR)/ms_R800_mac_30_debug.o $(BUILD_DIR)/ms_vdp_mac_debug.o $(BUILD_DIR)/ms_sysvalue_debug.o $(BUILD_DIR)/ms_sub_mac_debug.o $(BUILD_DIR)/ms_IO_PORT_debug.o $(BUILD_DIR)/ms_PSG_mac_debug.o $(BUILD_DIR)/ms_readcart_debug.o
	$(LD) $(LDFLAGS) -o $@ $^
