...
なお、X68000はグラフィック面を複数持っているので、そのうちの一つをBG面にすることもできなくはないですが、MSXも同時表示はできないもののGRAPHIC4は 16色の画面を最大 4面もって切り替えて表示したりできるので、それぞれをX68000のグラフィック 4面にわりあて、切り替えを瞬時にできるようにする必要があり、やはりBG面に割り当てるのはもったいないと考えています。
