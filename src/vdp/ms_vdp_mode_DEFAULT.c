...
void update_patgentbl_baddr_DEFAULT(ms_vdp_t* vdp, uint32_t addr);
void update_sprattrtbl_baddr_DEFAULT(ms_vdp_t* vdp, uint32_t addr);
void update_sprpatgentbl_baddr_DEFAULT(ms_vdp_t* vdp, uint32_t addr);
...
ms_vdp_mode_t ms_vdp_DEFAULT = {
	...
	// void update_patgentbl_baddr_DEFAULT(ms_vdp_t* vdp, uint32_t addr);
	update_patgentbl_baddr_DEFAULT,
	// void update_sprattrtbl_baddr_DEFAULT(ms_vdp_t* vdp, uint32_t addr);
	update_sprattrtbl_baddr_DEFAULT,
	// void update_sprpatgentbl_baddr_DEFAULT(ms_vdp_t* vdp, uint32_t addr);
	update_sprpatgentbl_baddr_DEFAULT,
	// void update_text_color_DEFAULT(ms_vdp_t* vdp);
