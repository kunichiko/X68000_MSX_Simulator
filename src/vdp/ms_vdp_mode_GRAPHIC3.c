...
void update_patgentbl_baddr_GRAPHIC3(ms_vdp_t* vdp, uint32_t addr);
void update_sprattrtbl_baddr_GRAPHIC3(ms_vdp_t* vdp, uint32_t addr);
void update_sprpatgentbl_baddr_GRAPHIC3(ms_vdp_t* vdp, uint32_t addr);
...
ms_vdp_mode_t ms_vdp_GRAPHIC3 = {
	...
	// void update_patgentbl_baddr_GRAPHIC3(ms_vdp_t* vdp, uint32_t addr);
	update_patgentbl_baddr_GRAPHIC3,
	// void update_sprattrtbl_baddr_GRAPHIC3(ms_vdp_t* vdp, uint32_t addr);
	update_sprattrtbl_baddr_GRAPHIC3,
	// void update_sprpatgentbl_baddr_GRAPHIC3(ms_vdp_t* vdp, uint32_t addr);
	update_sprpatgentbl_baddr_GRAPHIC3,
	// void update_text_color_GRAPHIC3(ms_vdp_t* vdp);
